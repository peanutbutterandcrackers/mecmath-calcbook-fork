...
%% \newcommand{\CRefstyle}[1]{\underline{\emph{#1}}}{}
\newcommand{\CRefstyle}[1]{#1}{}
\newcommand{\CRef}[2]{\hyperref[#1]{\CRefstyle{#2}}}{}
\newcounter{defn-counter}
\newcommand{\statedefn}[2]{
 \definecolor{defncolor}{HTML}{E6F0FF}
 \definecolor{defnrulecolor}{HTML}{0074C8}
 \refstepcounter{defn-counter}
 \begin{center}
...
\newcounter{thm-counter}
\newenvironment{thm}[0]{\refstepcounter{thm-counter}}{}
...
\begin{tikzpicture}[remember picture,overlay]
 ...
 \node[shape=rectangle,fill=gray,minimum height=\paperheight,minimum width=1.8in,anchor=west] at (current page.west) {};
\end{tikzpicture}
\end{flushright}
\restoregeometry
